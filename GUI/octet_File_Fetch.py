...
######################################################################
        def new_ok_button():
            if choice >= 1:
                ...
                submissin_Dict["Octet Active Quads 1"] = octet_active_quads_1
            if choice >= 2:
                octet_active_quads_2 = active_quads_2.get()
                submissin_Dict["Octet Active Quads 2"] = octet_active_quads_2
            if choice >= 3:
                octet_active_quads_3 = active_quads_3.get()
                submissin_Dict["Octet Active Quads 3"] = octet_active_quads_3
            new_window.destroy()
################################################################################
...
tk.Radiobutton(master=frame_1b, text="1", variable=question_1_answer, value=1, font=("Monospace", 12), background="#a3a3c2", command=open_fileInput).pack()
tk.Radiobutton(master=frame_1c, text="2", variable=question_1_answer, value=2, font=("Monospace", 12), background="#a3a3c2", command=open_fileInput).pack()
tk.Radiobutton(master=frame_1d, text="3", variable=question_1_answer, value=3, font=("Monospace", 12), background="#a3a3c2", command=open_fileInput).pack()
