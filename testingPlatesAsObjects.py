...
class QuantPlate:
    ...
    def __init__(self, plateNum, octetFilePath, numberOfQuads_fromOctetPlate):
        ...
        QuantPlate.numInstances += 1 #numInstance is the total count of class instances created
        self.count = QuantPlate.numInstances #count is the object instance number
